...
public class CalculatorDivTest extends AbstractCalculatorTest {
    ...
    @Test(description = "check div method for double format",
            dataProviderClass = DataProviderCalculatorDivTests.class,
            dataProvider = "divDataSet")
